    ...
    >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <h2
              className={`header-font text-4xl lg:text-5xl italic transition-colors duration-500 ${
            ...
            <div
              className={`space-y-6 text-base lg:text-[15px] leading-relaxed font-sans transition-colors duration-500 ${
                isDark ? "text-gray-400" : "text-[#1a0204]/70"
              }`}
            >
              <p>
                I am a{" "}
                ...
                and aspiring full-stack developer who builds scalable,
                database-driven web applications. I focus on creating systems
                that solve real problems and enjoy tackling complex challenges.
              </p>
              <p>
                I also enjoy designing reliable, production-ready applications,
                understanding data flow, and turning complex workflows into
                intuitive user experiences. My goal is to create software that
          ...
          <div className="grid grid-cols-2 gap-4 relative z-20">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <p
                  className={`text-[9px] tracking-[0.2em] font-bold uppercase font-sans transition-colors duration-500 ${
      ...
      <div
        ...
        style={{
          maskImage:
            "linear-gradient(to top left, black 20%, rgba(0,0,0,0.4) 60%, transparent 90%)",
          WebkitMaskImage:
            "linear-gradient(to top left, black 20%, rgba(0,0,0,0.4) 60%, transparent 90%)",
        }}
      >
